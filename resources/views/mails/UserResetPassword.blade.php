        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px; background-color: #ffffff; padding-bottom: 0px">
                            ...
                            <a href="{{ env('BASE_URL_FRONTEND', '') . $url }}"
                                style="font-size: 15px; font-weight: 600; background-color: #1c1e4d; color: #ffff; padding: 8px 40px; text-decoration: none; border-radius: 100px; display: inline-block; margin-top: 30px;">
                                Iniciar sesión
                            </a>
                        </td>
                    </tr>
