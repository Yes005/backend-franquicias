...
<head>
    ...
    <title>Notificación de aprobación de franquicia</title>
</head>
        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px; background-color: #ffffff; border-radius: 0 0 20px 20px;">
                            <p style="color: #1c1e4d; font-size: 20px; font-weight: 600;">
                                La solicitud de la franquicia {{ $codigoProvisional }} fue aprobada, su nuevo
                                código es:
                            </p>
