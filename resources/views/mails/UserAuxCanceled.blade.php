...
<head>
    ...
    <title>Solicitud de franquicia anulada</title>
</head>
        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td
                            style="padding: 20px; padding-top:0px; background-color: #ffffff; border-radius: 0 0 20px 20px;">
                            <p style="color: #1c1e4d; font-size: 20px; font-weight: 600;">
                                La solicitud de la franquicia
                                {{ $codigoFranquicia ? $codigoFranquicia : $codigoProvisional }} fue anulada
                            </p>
