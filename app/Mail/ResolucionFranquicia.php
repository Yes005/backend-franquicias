...
class ResolucionFranquicia extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Franquicias Presidenciales - Resolución de observación de franquicia',
        );
    }
    ...
    {
        return new Content(
            view: 'mails.UserBossSolvedNotification',
            with: [
